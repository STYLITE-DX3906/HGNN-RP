...
ap = argparse.ArgumentParser(description='NRSP testing for the IMDB dataset')
ap.add_argument('--save_postfix', default='IMDB', help='Postfix for the saved model and result. Default is IMDB.')
...
ap.add_argument('--feats_drop_rate', type=float, default=0.75, help='The dropout of attribute completion.')
...
# # 数据加载
features_list, Relational_features_list, adjM, type_mask, labels, train_val_test_idx = load_IMDB_data()
